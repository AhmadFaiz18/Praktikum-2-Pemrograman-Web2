...
<body>
    <form method="POST" action="form_belanja.php">
       ...
       <hr style="border: 0,;border-top:3px double#8c8c8c;background-color: yellow;">
        <div class="container">
            <div class="row">
                <div class="col-8">
                    <div class="form-group row mt-2 mx-3">
                    ...
                    <div class="form-group row mt-3 mx-3">
                        <div class="offset-2 col-6">
                            <input type="submit" name="proses" class="btn btn-warning">
                        </div>
                    </div>
                </div>
                <div class="col-4">
